...
public class AnnotationAttachment {
    ...
    /**
     * Set only for a binding sourced from a trigger metadata document, where the document states that
     * the annotation must be written. Never set for an attachment read off a symbol: whether an
     * annotation is mandatory is not something a symbol can express.
     */
